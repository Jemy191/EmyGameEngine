...
namespace VulkanHelper
{
	...
	{
		return FindQueueFamilies(VulkanRenderer::GetInstance()->GetPhysicalDevice()->GetVk());
	}
	...
	{
		return QuerySwapChainSupport(VulkanRenderer::GetInstance()->GetPhysicalDevice()->GetVk());
	}
